...
void main() async {
  ...
  // print(clazz.getType());
  // print(clazz.getAnnotation<Generic>()?.getType());
  // print(clazz.getAnnotation<Primary>());
  ...
  // print(dClass.getAnnotation<ConditionalOnMissingBean>());
  // print(dClass.getAnnotation<Component>());
  // print(dClass.getAnnotation<ConditionalOnProperty>());
  // print(dClass.getAnnotation<ConditionalOnBean>());
  ...
  // print(tClass.getAnnotation<ConditionalOnMissingBean>());
  // print(tClass.getAnnotation<Component>());
  // print(tClass.getAnnotation<ConditionalOnProperty>());
  // print(tClass.getAnnotation<ConditionalOnBean>());
  ...
  // final tInstance2 = tClass.newInstanceWithConstructor("withName", {"name": "John"});
