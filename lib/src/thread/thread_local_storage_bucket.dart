...
/// A mutable storage container for a [ThreadLocal] value, bound to a specific [Isolate].
///
...
///
/// Typically used internally by the [ThreadLocal] class to isolate thread-local
/// values per [Isolate].
///
/// ### Example
/// ```dart
...
/// ```
/// {@endtemplate}
@Generic(ThreadLocalStorageBucket)
final class ThreadLocalStorageBucket<T> {
  ...
  ///
  /// Creates a new [ThreadLocalStorageBucket] bound to the given [isolate].
  /// 
  /// If [initialValue] is provided, it is stored immediately.
  ThreadLocalStorageBucket(T? initialValue, Isolate isolate) : _isolate = isolate {
