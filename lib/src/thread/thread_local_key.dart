...
class ThreadLocalKey {
  ...
  final int id;
  ThreadLocalKey._(this.id); // Private constructor

  static int _nextId = 0; // Counter for generating unique IDs

  /// Generates a new unique [ThreadLocalKey].
  static ThreadLocalKey generate() => ThreadLocalKey._(_nextId++);

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ThreadLocalKey &&
