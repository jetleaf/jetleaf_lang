...
abstract class ClassLoader implements Closeable, Flushable {
  ...
  /// 
  /// Parameters:
  /// - [className]: The fully qualified class name (e.g., 'dart:core.String')
  ...
  /// print(superIterable?.qualifiedName); // e.g., "dart:core.Iterable"
  /// ```
  /// {@endtemplate}
  ...
  /// print(superIterableArgs.map((arg) => arg.qualifiedName)); // e.g., ["dart:core.Iterable"]
  /// ```
  /// {@endtemplate}
  ...
  /// ## Example
  /// ```dart
  /// final listClass = await loader.loadClass<List<String>>('dart:core.List');
  /// final stringType = loader.findComponentType<String>(listClass);
  /// print(stringType?.qualifiedName); // "dart:core.String"
  /// ```
  /// {@endtemplate}
  ...
  /// ## Example
  /// ```dart
  /// final mapClass = await loader.loadClass<Map<String, int>>('dart:core.Map');
  ...
  /// print(typeParams.map((arg) => arg.qualifiedName)); // e.g., ["dart:core.String"]
  /// ```
  /// {@endtemplate}
  ...
  /// print(componentType?.qualifiedName); // "dart:core.String"
  /// ```
  /// {@endtemplate}
  ...
  /// print(keyType?.qualifiedName); // "dart:core.String"
  /// ```
  /// {@endtemplate}
  ...
  /// final newClass = await loader.loadClass<String>('dart:core.String');
  /// ```
  /// 
  /// ## Performance Impact
